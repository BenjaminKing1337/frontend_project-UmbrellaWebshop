    ...
    <div id="border">
        ...
        <div class="col-25">
          ...
          <b>4</b>
                ...
                <br><p><a href="#">Product 1</a> <span class="price">$15</span></p>
                <br><p><a href="#">Product 2</a> <span class="price">$5</span></p>
                <br><p><a href="#">Product 3</a> <span class="price">$8</span></p>
                <br><p><a href="#">Product 4</a> <span class="price">$2</span></p><br>
                <hr>
                <br><p>Total <span class="price" style="color:#ffffff"><b>$30</b></span></p>
            </div>
        </div>
    </div>
    <v-row id="footer">
